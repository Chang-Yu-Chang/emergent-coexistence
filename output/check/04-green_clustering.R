...
for (i in 1:nrow(list_image_mapping_folder)) {
    ...
    folder_green_cluster <- list_image_mapping_folder$folder_green_cluster[i]
    ...
    ggsave(filename = paste0(folder_green_cluster, image_name, ".png"), plot = p, width = 10, height = 6)
