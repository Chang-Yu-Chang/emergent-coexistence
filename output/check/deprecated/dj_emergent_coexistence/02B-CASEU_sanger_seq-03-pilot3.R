...
# Isolate trace
trace_isolate <- data.table(FileName = paste0(folder_directory, genewiz_pilot3$`DNA Name`, "-27F.ab1"))
...
# Mixture trace
trace_mixture <- data.table(FileName = paste0(folder_directory, genewiz_pilot3$`DNA Name`, "-27F.ab1"))
