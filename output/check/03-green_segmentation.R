...
for (i in 1:nrow(list_images)) {
    ...
    #
    image_rolled <- readImage(paste0(folder_green_rolled, image_name, ".tiff"))
    ...
    writeImage(colorLabels(image_watershed2), paste0(folder_green_watershed, image_name, ".tiff"))
    cat("\twatershed")
