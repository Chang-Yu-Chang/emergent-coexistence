...
68 isolates used in the pairwise competition assay. The csv saves 
...
# 01D isolates growth rates (THIS SECTION IS DEPRECATED) (READ growth curve data)
...
For plotting growth rates data, use the melted isolate data.frame `isolates_melted`. 719 rows
...
```{r fig.width=5, fig.height=8, include = F}
