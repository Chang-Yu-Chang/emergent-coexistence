...
## From 02E
pairs_taxonomy <- fread(here::here("data/temp/pairs_taxonomy.csv"))
pairs_16S <- fread(here::here("data/temp/pairs_16S.csv"))
#pairs_tree_distance <- fread(here::here("data/temp/pairs_tree_distance.csv"))
