...
if (FALSE) {
  ...
  # Save plate figure ----
  pdf(root$find_file("output/protocol/tab_fig/protocol_20191205_random_network_T2-plate_layout.pdf"), width = 18, height = 10); p_plates; dev.off()
  pdf(root$find_file("output/protocol/tab_fig/protocol_20191205_random_network_T2-DNA_plate_layout.pdf"), width = 18, height = 10); p_plates_DNA; dev.off()
  save(plates_list, plates_DNA_list, p_plates, p_plates_DNA, file = root$find_file("output/protocol/tab_fig/protocol_20191205_random_network_T2-plate_layout.Rdata"))
