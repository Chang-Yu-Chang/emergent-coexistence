...
df_init <- read_simulation_data("~/Dropbox/lab/invasion-network/simulation/data/raw", paste0(pattern_exp_id, "_init")) %>% mutate(Time = 0)
...
S = 300 # number of species in the pool
