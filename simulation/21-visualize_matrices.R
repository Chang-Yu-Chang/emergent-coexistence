...
Dm_S0 <- read_csv(paste0(output_dir, "00-D_S0.csv"), skip = 1, col_types = cols()) # D matrix
Dm_S500 <- read_csv(paste0(output_dir, "00-D_S500.csv"), skip = 1, col_types = cols()) # D matrix
