...
p1 <- net %>%
    ...
    geom_edge_link(aes(color = InteractionType), width = 2,
                   arrow = arrow(length = unit(node_size/2-5, "mm"), type = "closed", angle = 30, ends = "last"),
...
pA <- p_net +
    draw_image(here::here("plots/cartoons/Fig1B_1.png"), x = -.2, y = -1, vjust = 0.5, hjust = 0, clip = "on", scale = .8) +
    draw_image(here::here("plots/cartoons/Fig1B_3.png"), x = .2, y = -1, vjust = 0.5, hjust = 0, clip = "on", scale = .8) +
    draw_image(here::here("plots/cartoons/Fig1B_4.png"), x = -.2, y = -3, vjust = 0.5, hjust = 0, clip = "on", scale = .8) +
    draw_image(here::here("plots/cartoons/Fig1B_2.png"), x = .2, y = -3, vjust = .6, hjust = 0, clip = "on", scale = .8) +
...
temp <- p_net_hierarchy_list[[13]] +
    geom_edge_arc(strength = 10,
                  aes(color = InteractionType), width = edge_width*2,
                  arrow = arrow(length = unit(edge_width*2, "mm"), type = "closed", angle = 30, ends = "last"),
                  start_cap = circle(node_size/2, "mm"),
                  end_cap = circle(node_size/2, "mm")) +
