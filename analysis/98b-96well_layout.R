#' It generates the 96-well plate layout
#' Output: plate.csv
...
plate_B2_933_P3 <- mutate(plate_B2_933, Plate = "P3", Isolate1Freq = 95, Isolate2Freq = 5)
...
plate_B2_444_P3 <- mutate(plate_B2_444, Plate = "P3",Isolate1Freq = 95, Isolate2Freq = 5)
...
plate_C2_13A_P3 <- mutate(plate_C2_13A, Plate = "P3", Isolate1Freq = 95, Isolate2Freq = 5)
...
plate_C2_13B_P3 <- mutate(plate_C2_13B, Plate = "P3",Isolate1Freq = 95, Isolate2Freq = 5)
...
plate_D_75_P3 <- mutate(plate_D_75, Plate = "P3", Isolate1Freq = 95, Isolate2Freq = 5)
...
plate_D_5543_P3 <- mutate(plate_D_5543, Plate = "P3", Isolate1Freq = 95, Isolate2Freq = 5)

plates <- rbind(plate_B2_933_P1, plate_B2_933_P2, plate_B2_933_P3, plate_B2_444_P1, plate_B2_444_P2, plate_B2_444_P3,
                plate_C_C11R1_P1,
                plate_C2_13A_P1, plate_C2_13A_P2, plate_C2_13A_P3,
                plate_C2_13B_P1, plate_C2_13B_P2, plate_C2_13B_P3,
                plate_D_75_P1, plate_D_75_P2, plate_C2_13B_P3,
                plate_D_5543_P1, plate_D_5543_P2, plate_D_5543_P3)
