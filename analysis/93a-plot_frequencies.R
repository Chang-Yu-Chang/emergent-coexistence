...
for (i in 1:nrow(pairs_ID)) {
    ...
    ggsave(paste0(folder_main, "images/meta-93-T0_T8_frequencies/bootstrapped/", pair_name, ".png"), p, width = 10, height = 5)
    write_csv(pair_boots_table, paste0(folder_main, "images/meta-93-T0_T8_frequencies/bootstrapped/", pair_name, ".csv"))
