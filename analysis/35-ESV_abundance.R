...
# Check abundance vs. invasion fitness, ESVs present in stable communities, linear fit, T1-12 ----
# ESVs that are present from T8-12
ESV_stable <- communities_temporal %>%
...
ggsave(paste0(folder_data, "temp/35-09-species_fitness_extinct.png"), p, width = 10, height = 6)
