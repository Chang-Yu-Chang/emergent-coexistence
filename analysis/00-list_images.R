...
for (j in 1:length(batch_names)) {
    ...
    list_images <- tibble(
        ...
        folder_channel = rep(paste0(folder_main, "images/", batch_names[j], "-01-channel/"), n_images),
        folder_rolled = rep(paste0(folder_main, "images/", batch_names[j], "-02-rolled/"), n_images),
        folder_threshold = rep(paste0(folder_main, "images/", batch_names[j], "-03-threshold/"), n_images),
        folder_round = rep(paste0(folder_main, "images/", batch_names[j], "-04-round/"), n_images),
        folder_watershed = rep(paste0(folder_main, "images/", batch_names[j], "-05-watershed/"), n_images),
        folder_transect = rep(paste0(folder_main, "images/", batch_names[j], "-06-transect/"), n_images),
        folder_feature = rep(paste0(folder_main, "images/", batch_names[j], "-07-feature/"), n_images),
        folder_logit = rep(paste0(folder_main, "images/", batch_names[j], "-08-logit/"), n_images),
        folder_random_forest = rep(paste0(folder_main, "images/", batch_names[j], "-09-random_forest/"), n_images),
        folder_bootstrap = rep(paste0(folder_main, "images/", batch_names[j], "-10-bootstrap/"), n_images),
        folder_combined = rep(paste0(folder_main, "images/", batch_names[j], "-11-images_and_random_forest/"), n_images)
    )
