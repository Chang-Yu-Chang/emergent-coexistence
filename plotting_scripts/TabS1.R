...
features <- tibble(Feature = names(features_example)) %>%
    ...
    mutate(Description =
               c("area size (in pixels)",
                 ...
                 "green channel pixel intensity at 5th percentile distance away from the object center on the scaled transect",
                 "green channel pixel intensity at 10th percentile distance away from the object center on the scaled transect",
                 "green channel pixel intensity at 50th percentile distance away from the object center on the scaled transect",
                 "green channel pixel intensity at 90th percentile distance away from the object center on the scaled transect",
                 "green channel pixel intensity at 95th percentile distance away from the object center on the scaled transect",
