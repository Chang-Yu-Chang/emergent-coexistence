...
p <- plot_grid(
    plot_grid(p1, NULL, ncol = 1, rel_heights = c(1, 3)),
    p2, p3,
    labels = LETTERS[1:3], scale = c(.95, .95, .95),
    nrow = 1, align = "h", axis = "tb", rel_widths = c(1, 1 ,1.2)) +
    paint_white_background()
ggsave(here::here("plots/FigS5-transient_negative_fitness.png"), p, width = 12, height = 17)
