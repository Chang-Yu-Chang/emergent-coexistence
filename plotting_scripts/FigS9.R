...
read_csv(paste0(folder_data, "temp/92-pairs_T8_combined.csv"), show_col_types = F) %>%
    filter(!is.na(Isolate1CFUFreq_human)) %>%
...
ggsave(here::here("plots/FigS9-human_machine_comparison.png"), p, width = 8, height = 4)
